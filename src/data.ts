...
export const INITIAL_DATA: SchoolData[] = [
  // 京都エリア (24)
  { id: 'kyoto-01', name: '大宮', region: 'Kyoto', target: 705, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '木下課長+山崎チーフ', examTarget: 400, examAchievement: 0, examRate: 0, examStage: 1 },
  { id: 'kyoto-02', name: '帷子ノ辻', region: 'Kyoto', target: 635, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '葛本チーフ＋西向日', examTarget: 418, examAchievement: 0, examRate: 0, examStage: 1 },
  { id: 'kyoto-03', name: '北野', region: 'Kyoto', target: 484, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '葛本チーフ＋西向日', examTarget: 346, examAchievement: 0, examRate: 0, examStage: 1 },
  { id: 'kyoto-04', name: '北山', region: 'Kyoto', target: 370, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '木下課長+山崎チーフ', examTarget: 280, examAchievement: 0, examRate: 0, examStage: 1 },
  { id: 'kyoto-05', name: '西賀茂', region: 'Kyoto', target: 298, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '葛本チーフ＋西向日', examTarget: 236, examAchievement: 0, examRate: 0, examStage: 1 },
  { id: 'kyoto-06', name: '烏丸御池', region: 'Kyoto', target: 633, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '木下課長+山崎チーフ', examTarget: 548, examAchievement: 0, examRate: 0, examStage: 1 },
  ...
  { id: 'kyoto-11', name: '東向日', region: 'Kyoto', target: 895, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '葛本チーフ＋西向日', examTarget: 676, examAchievement: 0, examRate: 0, examStage: 1 },
  { id: 'kyoto-12', name: '西向日', region: 'Kyoto', target: 1013, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '葛本チーフ＋西向日', examTarget: 784, examAchievement: 0, examRate: 0, examStage: 1 },
  ...
  { id: 'kyoto-15', name: '墨染', region: 'Kyoto', target: 571, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '木下課長+山崎チーフ', examTarget: 344, examAchievement: 0, examRate: 0, examStage: 1 },
  ...
  { id: 'kyoto-23', name: '久我', region: 'Kyoto', target: 660, achievement: 0, rate: 0, stage: 1, team: '木下チーム', area: '葛本チーフ＋西向日', examTarget: 480, examAchievement: 0, examRate: 0, examStage: 1 },
